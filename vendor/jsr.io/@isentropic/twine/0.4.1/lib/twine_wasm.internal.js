 ...
 * @returns {string[]}
 */
export function get_supported_quantities() {
  const ret = wasm.get_supported_quantities();
 ...
 * @returns {any}
 */
export function hx_known_conductance_and_inlets(arrangement, ua, c1, t1, c2, t2) {
  const ret = wasm.hx_known_conductance_and_inlets(arrangement, ua, c1, t1, c2, t2);
  if (ret[2]) {
